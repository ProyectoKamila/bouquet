...
/*
  Generated class for the ProveePerfil page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-provee-perfil',
  templateUrl: 'provee-perfil.html'
})
export class ProveePerfil {
   nombre;
  correo;
  img;
  telefono;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ProveePerfilPage');
  }
